...
#adreno
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/adreno/bin/gpu_dcvsd:system/bin/gpu_dcvsd \
	...
	$(LOCAL_PATH)/adreno/etc/firmware/yamato_pfp.fw:system/etc/firmware/yamato_pfp.fw \
	$(LOCAL_PATH)/adreno/etc/firmware/yamato_pm4.fw:system/etc/firmware/yamato_pm4.fw \
	...
	$(LOCAL_PATH)/adreno/lib/libllvm-a3xx.so:system/lib/libllvm-a3xx.so \
	$(LOCAL_PATH)/adreno/lib/libOpenCL.so:system/lib/libOpenCL.so \
	$(LOCAL_PATH)/adreno/lib/libCB.so:system/lib/libCB.so \
